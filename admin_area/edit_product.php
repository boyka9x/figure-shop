...
?>
          ...
          <div class="panel-body">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <textarea name="product_info" class="form-control" cols="30" rows="10" required><?php echo $p_info; ?></textarea>
  ...
  if (isset($_POST['update'])) {
    ...
    $update_product = "update products set p_cat_id='$product_cat',manufacturer_id='$manufacturer_id',date=NOW(),product_title='$product_title',product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_price='$product_price',product_psp_price='$psp_price',product_info='$product_info',product_keywords='$product_keywords',product_label='$product_label' where product_id='$p_id'";
