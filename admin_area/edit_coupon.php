...
?>
    ...
    if (isset($_POST['update'])) {
        ...
        if ($coupon_limit <= 0) {
            echo "<script>alert('Error number limited')</script>";
            exit;
        }

        $update_coupon = "update coupons set product_id='$product_id',coupon_title='$coupon_title',coupon_price='$coupon_price',coupon_code='$coupon_code',coupon_limit='$coupon_limit' where coupon_id='$c_id' and coupon_used <= '$coupon_limit'";
